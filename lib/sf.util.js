...
SFCheck.prototype.process = function(name, opts) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    const lostParams = _.filter(mustHaveParams, function(param) { return !_.includes(userHavaParams, param) })
...
SFCheck.prototype.OrderSearchService = function(orderId){
  return new Promise().resolve(isPass())
}

SFCheck.prototype.RouteService = function(routeId) {
  return new Promise().resovle(isPass())
}
